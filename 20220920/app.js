...
let Pessoas = require('./modules/dados').Pessoas;
...
// importar modulo com a funcao construtora de objetos Pessoa
const Pessoa = require('./modules/f_constr_dados');
...
Pessoas.push(new Pessoa(1.70, 'M'));
Pessoas.push(new Pessoa(1.71, 'F'));
