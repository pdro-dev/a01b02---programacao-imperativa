...
Faça um programa que receba a idade e a opinião de 15 espectadores, calcule e
imprima:
    1. a média das idades das pessoas que responderam ótimo;
    2. a quantidade de pessoas que responderam regular;
    3. a porcentagem de pessoas que responderam bom entre todos os
espectadores analisados.
*/

// cria um array com 15 objetos
let espectadores = [
    { idade: 20, opiniao: 3 },
    { idade: 25, opiniao: 2 },
    { idade: 30, opiniao: 1 },
...
// imprimir usando template string
console.log(`A média das idades das pessoas que responderam ótimo é ${mediaIdade(espectadores).toFixed(2)}`);
...
// imprimir usando template string
console.log(`A quantidade de pessoas que responderam regular é ${qtdRegular(espectadores)}`);

//3 a porcentagem de pessoas que responderam bom entre todos os espectadores analisados.
const porcentagemBom = array => {
    let qtdBom = 0;
    let porcentagem = 0;
    for (i = 0; i < array.length; i++) {
        let Aux = array[i];
    ...
    porcentagem = (qtdBom * 100) / array.length;
    return porcentagem;
};
// imprimir usando template string
console.log(`A porcentagem de pessoas que responderam bom entre todos os espectadores analisados é ${porcentagemBom(espectadores).toFixed(2)}%`);
